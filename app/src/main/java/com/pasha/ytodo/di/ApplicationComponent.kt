...
@ApplicationScope
@Component(modules = [ApplicationModule::class, TasksModule::class, EditModule::class, SettingsModule::class])
interface ApplicationComponent: TasksDeps, EditDeps, SettingsDeps {
    @Component.Factory
    interface Factory {
